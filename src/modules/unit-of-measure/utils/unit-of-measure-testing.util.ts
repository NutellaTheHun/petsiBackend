...
export class UnitOfMeasureTestingUtil {
  ...
  public async getCategoryEntities(
    testContext: DatabaseTestContext,
  ): Promise<UnitOfMeasureCategory[]> {
    return [
      await await this.categoryBuilder.reset().name(CONSTANTS.UNIT).build(),
      await await this.categoryBuilder.reset().name(CONSTANTS.VOLUME).build(),
      await await this.categoryBuilder.reset().name(CONSTANTS.WEIGHT).build(),
    ];
  }
   ...
   * @returns
   */
  public async getUnitsOfMeasureEntities(
    testContext: DatabaseTestContext,
  ...
  public async initUnitCategoryTestDatabase(
    testContext: DatabaseTestContext,
  ): Promise<void> {
  ...
  public async initializeDefaultCategoryBaseUnits(): Promise<void> {
    ...
    await await this.setCategoryBaseUnit(
      CONSTANTS.VOLUME,
  ...
  public async setCategoryBaseUnit(
    categoryName: string,
