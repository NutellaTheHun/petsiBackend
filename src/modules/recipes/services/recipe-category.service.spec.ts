...
describe('recipe category service', () => {
    ...
    it('should update category', async () => {
        ...
        const dto: UpdateRecipeCategoryDto = plainToInstance(UpdateRecipeCategoryDto, { name: 'Updated Category A' });
    ...
    it('should update category with NestedUpdateRecipeSubCategoryDto and NestedCreateRecipeIngredientDto', async () => {
        ...
        const dto: UpdateRecipeCategoryDto = plainToInstance(UpdateRecipeCategoryDto, {
            subCategories: [
                plainToInstance(NestedUpdateRecipeSubCategoryDto, { id: existing.id, name: 'Updated Sub' }),
                plainToInstance(NestedCreateRecipeSubCategoryDto, { createId: 'c2', name: 'New Sub' }),
            ],
        });
