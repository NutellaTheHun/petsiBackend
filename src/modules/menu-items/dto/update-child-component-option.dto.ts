...
export class UpdateChildComponentOptionDto {
    @ApiProperty({ description: 'Declare whether creating or updating a child entity. Relevant when creating/updating a Menu-Item-Component-Option entity.' })
    @IsNotEmpty()
    readonly mode: 'update' = 'update';

    @ApiProperty({ description: 'Id of the Component-Option to update.' })
    @IsNumber()
    @IsPositive()
    @IsNotEmpty()
    readonly id: number;
