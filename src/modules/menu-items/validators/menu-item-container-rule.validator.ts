...
export class MenuItemContainerRuleValidator extends ValidatorBase<MenuItemContainerRule> {
    ...
    public async validateCreate(dto: CreateChildMenuItemContainerRuleDto): Promise<void> {
    ...
    public async validateUpdate(id: number, dto: UpdateMenuItemContainerRuleDto | UpdateChildMenuItemContainerRuleDto): Promise<void> {
