...
export class OrderContainerItemValidator extends ValidatorBase<OrderContainerItem> {
    ...
    public async validateCreate(dto: CreateChildOrderContainerItemDto): Promise<ValidationError[]> {
    ...
    public async validateUpdate(id: number, dto: UpdateOrderContainerItemDto | UpdateChildOrderContainerItemDto): Promise<ValidationError[]> {
